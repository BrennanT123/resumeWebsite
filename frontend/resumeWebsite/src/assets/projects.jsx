...
function Projects() {
  ...
  return (
    <div>
      <h1>Projects</h1>
      <div className={projectStyles.projectButtonsContainer}>
        {projects.map((project) => (
          <div
            key={project.id}
            onClick={() => handleProjectClick(project.id)}
            className={`${projectStyles.projectButton} ${
              activeProject === project.id
                ? projectStyles.activeProjectButton
                : ""
            }`}
          >
            {project.title}
                ...
                return (
                  <div
                    ...
                    className={`${projectStyles.projectContainer} ${
                      activeProject === project.id ? projectStyles.slideIn : ""
                    }`}
                  >
